...
* [Landing requires a non-empty array of validated, non-no-op changes](landing-requires-a-validated-non-noop-change.md) - Nothing can be committed that is byte-stable or unvalidated, and land cannot be called with zero manifests — the type system enforces both, not a call-site convention.
